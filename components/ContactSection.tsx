  ...
  return (
    <section className="py-20 bg-gradient-to-b dark:from-gray-900 dark:to-gray-800">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold dark:text-white mb-4">Get in Touch</h2>
        ...
        <div className="flex flex-col md:flex-row items-start justify-center gap-16">
          ...
          >
            ...
            <div className="mt-8">
              <h4 className="text-xl font-semibold dark:text-white mb-4">Connect with me</h4>
            ...
            <form onSubmit={handleSubmit} className="space-y-6 lg:min-w-[600px] w-full">
              <div>
                ...
                <input
                  ...
                  required
                  className="mt-1 p-3 block w-full rounded-md bg-gray-700 border-gray-600 text-white shadow-sm focus:border-purple-500 focus:ring-purple-500"
                />
              </div>
              <div>
